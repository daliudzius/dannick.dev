...
export default function Home() {
   return (
      <div className='flex flex-col min-h-screen'>
         ...
         <Navbar />
         <main className='flex-grow p-8 overflow-y-auto text-bluegray-800 dark:text-bluegray-50'>
            <p>Hi friend, I'm</p>
            <h1 className='my-1 text-4xl font-bold'>Dannick</h1>
            <SocialLinks />
            ...
            <div className='flex justify-center mt-8'>
               <button className='flex items-center justify-center w-40 border-2 border-purple-600 rounded dark:border-purple-400 h-14'>
                  <svg
                     viewBox='0 0 16 16'
